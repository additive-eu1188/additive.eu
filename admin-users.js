...
.data-table td:nth-child(1) { width: 80px !important; min-width: 80px !important; } /* Actions */

.data-table th:nth-child(2),
.data-table td:nth-child(2) { width: 100px !important; min-width: 100px !important; } /* Phone - 加宽 */

.data-table th:nth-child(3),
.data-table td:nth-child(3) { width: 80px !important; min-width: 80px !important; } /* User ID + Position */

.data-table th:nth-child(4),
.data-table td:nth-child(4) { width: 70px !important; min-width: 70px !important; } /* Referrer */

.data-table th:nth-child(5),
.data-table td:nth-child(5) { width: 50px !important; min-width: 50px !important; } /* Country */

.data-table th:nth-child(6),
.data-table td:nth-child(6) { width: 55px !important; min-width: 55px !important; } /* VIP */

.data-table th:nth-child(7),
.data-table td:nth-child(7) { width: 60px !important; min-width: 60px !important; } /* Pending */

.data-table th:nth-child(8),
.data-table td:nth-child(8) { width: 65px !important; min-width: 65px !important; } /* Balance */

.data-table th:nth-child(9),
.data-table td:nth-child(9) { min-width: 280px !important; } /* Round / Orders - 稍微缩小给Phone让空间 */

.data-table th:nth-child(10),
.data-table td:nth-child(10) { width: 80px !important; min-width: 80px !important; } /* Registered IP */

.data-table th:nth-child(11),
.data-table td:nth-child(11) { width: 80px !important; min-width: 80px !important; } /* Last Online */
